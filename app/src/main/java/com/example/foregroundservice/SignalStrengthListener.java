...
public class SignalStrengthListener {
    private static final String TAG = SignalStrengthListener.class.getSimpleName();
    ...
    public class SignalStrengthTelephonyCallback extends TelephonyCallback
            implements TelephonyCallback.SignalStrengthsListener {
        @Override
        public void onSignalStrengthsChanged(@NonNull SignalStrength signalStrength) {
            mCallback.onSignalStrengthChanged(signalStrength);
        }
    }

    public SignalStrengthListener(Context context, int phoneId, Callback callback) {
